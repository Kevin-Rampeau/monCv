...
//DECLARATION VARIABLE
	...
	fonctionTir3 = function(){
		...
		function deplacement(timestamp){
			...
			arret3 = requestAnimationFrame(deplacement);
		};
		clearTimeout(clr3);
		requestAnimationFrame(deplacement);
		tir1.css('display','');
		cancelAnimationFrame(arret3);
	}
});	
